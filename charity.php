									...
									<!-- TOP BAR NAVIGATION -->
										<nav id="nav">
											<ul>
												...
												<li class="current_page_item"><a href="charity.php">Charity Events</a></li>
					...
					<div class="12u">
							...
							<!-- Portfolio -->
								...
								<div class="slider-wrapper">
									<div id="slider">
										<div class="slide1">
										<img  src="images/picCharity01-01.jpg" alt="" />
										<header style="background-color: transparent;">
										</header>
										</div>
											<div class="slide2">
											<img  src="images/picCharity01-02.jpg" alt="" />
											<header style="background-color: transparent;">
										</header>
											</div>
												<div class="slide3">
												<img src="images/picCharity01-03.jpg" alt="" />
												<header style="background-color: transparent;">
										</header>
												</div>
													</div>
