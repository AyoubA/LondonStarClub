...
function dialogAddNewEvent() {
  echo '   <div id="dialog-add-event" title="Add New Event" style="display: none;">
  ...
  <fieldset>
    ...
    <select name="typeID">
		...
		<option value="4"> Club Night </option>
	...
	<td>
    <input size="45" type="text" name="companyID"  class="text ui-widget-content ui-corner-all">
	</td>
	</tr>
	<tr>
	<td>
	...
	<td>
	<input type="time"  value="20:30" name="timeStart"  />
	</td>
	</tr>
	<tr>
	<td>
	...
	<td>
	<input type="time"  value="03:00" name="timeEnd"  />
	</td>
	</tr>
		<tr>
	<td>
	...
	<td>
	<select name="venueID">
  <option value="1">Tiger Tiger</option>
  <option value="2">Piccadilly Institute</option>
  <option value="3">Aqua</option>
  <option value="4">Sway</option>
</select> 
	</td>
	</tr>
	<tr>
	<td> <label for="priceMale"> Price (Male): <label> </th>
    <td>
    <input size="45" type="text" name="priceMale" id="name" class="text ui-widget-content ui-corner-all">
	</td>
	</tr>	
	<tr>
	<td> <label for="priceFemale"> Price (Female): <label> </th>
    <td>
    <input size="45" type="text" name="priceFemale" id="name" class="text ui-widget-content ui-corner-all">
	</td>
	</tr>
	<tr>
	<td> <label for="discount"> Member Discount: <label> </th>
    <td>
    <input size="45" type="text" name="discount" id="name" class="text ui-widget-content ui-corner-all">
	</td>
	</tr>
	<tr>
	<td> <label for="stock"> Ticket Stock : <label> </th>
    <td>
    <input size="45" type="text" name="stock" id="name" class="text ui-widget-content ui-corner-all">
	</td>
	</tr>
	<td> <label for="flyer"> Flyer Name : <label> </th>
    <td>
    <input size="45" type="text" name="flyer" id="name" class="text ui-widget-content ui-corner-all">
	</td>
	</tr>
  ...
  <input type="hidden" name="function" value="addNewEvent">
