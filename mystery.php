									...
									<!-- TOP BAR NAVIGATION -->
										<nav id="nav">
											<ul>
												...
												<li class="current_page_item"><a href="mystery.php">Mystery Club/Happy Hour </a></li> <!-- make it stand out -->
						...
						<div class="12u">
										...
										<div class="row">
											<div class="4u">
												...
												<!-- Sidebar -->
													<section class="box">
														<a href="http://facebook.com/LondonStarClub" class="image image-full"><img src="images/picMystery02.jpg" alt="" /></a>
														<header>
															<h3>Last Event @ Gem Bar, Oxford Street </h3>
														</header>
											...
											<div class="8u skel-cell-important">
												...
												<!-- Content -->
													<article class="box is-post">
														<a href="http://facebook.com/DreametryDoodle" class="image image-full"><img src="images/picMystery01.jpg" alt="" /></a>
														<header>
															<h2>Mystery Club and Happy Hour</h2>
															<span class="byline">Half Price Drinks All Night!</span>
														</header>
														<p>
															Quick description of what is expected of mystery nights and when we run them, how much they are, how they differ 
